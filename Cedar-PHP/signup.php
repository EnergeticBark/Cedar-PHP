...
<input name="face-type" type="radio" value="2" style="margin-left: 5px; display: inline;"></div>
                <div class="custom-face"><p style="display: inline">Profile picture upload: </p><input type="file" name="face" style="max-width: 230;" accept="image/*"></div>
                <div class="nnid-face none"><p style="margin: 0;">Enter the NNID for the Mii you want to use.</p>
                <input type="text" name="face" maxlength="16" placeholder="NNID"></div>
                </lable>
