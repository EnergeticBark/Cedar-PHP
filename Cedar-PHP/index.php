...
$router->addRoutes(array(
	...
	array('GET|POST', '/titles/[i:title_id]/hot', 'popularPosts.php', 'Popular-posts'),
	...
	array('GET', '/communities/categories/all', 'allTitles.php', 'All-Titles'),
	...
	array('POST', '/users/[*:action]/friend.new', 'sendFriendRequest.php', 'Send-Friend-Request')
