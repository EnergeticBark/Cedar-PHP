...
if($title_result->num_rows == 0){ exit("<br/>Could not find community"); }
...
if((isset($_GET['offset']) && is_numeric($_GET['offset'])) && isset($_GET['dateTime'])){
	...
	if ($title['perm'] < 1){
		...
		<div class="tab2"><a id="posts-filter-anchor" class=" selected" href="/titles/'. $title['title_id'] .'"><span class="new-posts">All Posts</span></a><a class="" href="/titles/'. $title['title_id'] .'/hot">Popular posts</a>
		</div>
		</div>';
